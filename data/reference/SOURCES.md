...
| `items.json` | Pathfinder 1E RAW/SRD snapshot curato offline + seed meccanico bilingue e pattern matching per armi, armature, scudi, oggetti meravigliosi, consumabili e gear | OGL 1.0a | Paizo Inc. / d20PFSRD | 2026-07-16 | 257 | `source_id`, `name`, `source`, `tags`, `prerequisites`, `references`, `reference_urls`, `description` | Nessun nome proprio di setting; descrizioni generate sono riassunti meccanici OGL (statistiche danno, bonus, slot, CL, price, construction requirements) senza fluff narrativo. | 257/257 voci arricchite con `description` via `tools/enrich_items.py`; copertura 100% con mix di template canonici, pattern su varianti +N/materiali e fallback per item custom/italiani. |
| `classes.json` | Generato da `tools/generate_classes_races_archetypes.py` come riassunti meccanici OGL + import AoN (`tools/import_reference.py`, lotto 2026-07-19) | OGL 1.0a | Paizo Inc. / d20PFSRD | 2026-07-19 | 24 | `source_id`, `name`, `source`, `tags`, `prerequisites`, `references`, `reference_urls`, `notes` | Nessun nome proprio di setting; descrizioni sono riassunti meccanici originali in italiano. | 24 classi: 11 core + Magus (UM) + 4 APG + 1 UC + 5 ACG + 2 OA. |
...
- ~~Valutare l'espansione con altre classi base~~ **Fatto (2026-07-19)**: `classes.json` copre ora 24 classi (11 core + Magus (UM) + 4 APG + 1 UC + 5 ACG + 2 OA). Restano escluse le classi non importate (es. Summoner, Oracle, Ninja, Samurai, Occultist).
