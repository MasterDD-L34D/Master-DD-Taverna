...
`POST /pc/build` — costruzione deterministica PG lv1 dai cataloghi OGL (point-buy, razza, classe, skill, talenti, tratti, equip; 422 con lista errori di validazione. Limitazione nota: gli effetti meccanici dei talenti non vengono applicati ai valori (lv1)). Vedi `src/pc/`.
